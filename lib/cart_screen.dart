...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('My Products', style: TextStyle(fontWeight: FontWeight.w500),),
        centerTitle: true,
                      ...
                      return Column(
                        ...
                        children: [
                          Center(child: Padding(
                            ...
                            child: Image(image: AssetImage('images/ebox.png')),
                          )),
                          Text('Explore Products', style: Theme.of(context).textTheme.headlineSmall)
                        ],
                      );
                    }else {
                      return Expanded(
